...
if(window.location.href.includes('show-video-card-only') === true){
...
if(window.location.href.includes('hide__ts-') === true){
    var style = document.createElement('style');
    style.innerHTML = `
    header {
    display: none !important;
